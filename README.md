A collection of excpetions for Http response code.
See netex_http for a ready-to-use implementation.

## Features

All Http response codes beginning with 4xx or 5xx are implemented as exceptions.
